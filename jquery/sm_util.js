...
//可以打印json数据，结果为:[{String:Object,String:Object},{},{}]。如果直接alert(json)则输出:[object Object],[object Object]
 ...
 * @return {TypeName}
 */
function sm_numberToChinese(num) {
...
/* 文件大小转换为MB GB KB格式 */
function sm_countFileSize(size) {
